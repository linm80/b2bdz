...
var addingOffre = document.getElementById('addingOffre');
var addingOffre2 = document.getElementById('addingOffre2');

document.getElementById('addOffre').addEventListener('click', function () {
    addingOffre.classList.add('show-page');
    ...
    grid.classList.remove('show-page');
    service1.classList.remove('show-page');
    offreService.classList.remove('show-page');
    addingOffre2.classList.remove('show-page');
});
document.getElementById('addOffreServ').addEventListener('click', function () {
    addingOffre.classList.add('show-page');
    offres.classList.remove('show-page');
    contact.classList.remove('show-page');
    info.classList.remove('show-page');
...
document.getElementById('addOffreEvent').addEventListener('click', function () {
    addingOffre.classList.add('show-page');
    offres.classList.remove('show-page');
    contact.classList.remove('show-page');
    info.classList.remove('show-page');
...
document.getElementById('addOffre2').addEventListener('click', function () {
    addingOffre2.classList.add('show-page');
    offres.classList.remove('show-page');
    contact.classList.remove('show-page');
    info.classList.remove('show-page');
    acceuil.classList.add('acceuil');
    ...
    service1.classList.remove('show-page');
    offreService.classList.remove('show-page');
    addingOffre.classList.remove('show-page');
});
